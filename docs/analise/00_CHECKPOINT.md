...
> Última atualização: **04.09.2026 (v5)** — planilha-entregável reestruturada em 5 abas visíveis (Premissas → Cálculos → CPC 19 → Alienação Futura → Conclusão), com logo/título uniformes; PL 254/127/127/800 e VM CNP 822.
...
| Planilha-entregável com a aba "Segregação de Risco" (v4, 04.09) — superada | ✅ | `planilhas/Embracon_simulacao_tributaria_04.09.26_v4.xlsx`; gerador `build_segregacao_sim.py`; explicação em `docs/analise/12_aba_segregacao_risco_v4.md` |
| **Planilha-entregável v5 (04.09, tarde)** ⭐ vigente — abas Premissas / Cálculos / CPC 19 / Alienação Futura / Conclusão, logo+título uniformes | ✅ | `planilhas/Embracon_simulacao_tributaria_04.09.26_v5.xlsx` (base: `..._v4 (fonte usuario).xlsx`, editada pelo usuário); gerador `build_v5.py` + `inject_values_v5.py`; mapa de abas/vínculos em `docs/analise/13_planilha_v5_estrutura_abas.md` |
